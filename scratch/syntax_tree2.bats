...
@test "parse standalone verb 'look'" {
  run bash scratch/syntax_tree2.sh look
  assert_success
...
@test "parse standalone verb 'yell'" {
  run bash scratch/syntax_tree2.sh yell
  assert_success
...
@test "parse 'go north'" {
  run bash scratch/syntax_tree2.sh go north
  assert_success
...
@test "parse 'take stick'" {
  run bash scratch/syntax_tree2.sh take stick
  assert_success
...
@test "parse 'take the stick'" {
  run bash scratch/syntax_tree2.sh take the stick
  assert_success
  assert_output --partial "verb=verb::take"
  assert_output --partial "dobject=stick"
  assert_output --partial "iobject="
...
@test "parse 'attack troll with sword'" {
  run bash scratch/syntax_tree2.sh attack troll with sword
  assert_success
